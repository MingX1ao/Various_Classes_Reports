...
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { clk }];     //改动
...
#BTN
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { clr }];      //改动
...
set_property -dict { PACKAGE_PIN K19   IOSTANDARD LVCMOS33 } [get_ports { an[0] }];      //以下全改动
...
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { sw[3] }];       //到此为止
